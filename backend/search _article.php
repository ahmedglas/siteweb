   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#!"><i class="fa fa-database" aria-hidden="true"></i>Système de gestion > search</a>
        </div>
...
<div  class="container">
  <p style="text-align: center; color: #004d99 !important;">Chercher un article</p>
  <hr>
          ...
          <div class='col-sm-5 col-sm-offset-3'>
              <div class='panel panel-default'>
               <div class='panel-heading'>
                <h3 style='text-align:center;' class='panel-title'><b>resulta trouver pour => $requete_user </b></h3>
 ...
 Notre système ne reconnais pas => <em style='color:#001a33; font-size:30px;'>$requete_user</em>  </b></>
  ...
  <div class="bcg" class="container">
            ...
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <p style="color:#004d99; text-align: center;"  >windunix.ml &copy; 2018, All Rights Reserved</p>
                <marquee direction="down">
                <p style="color:#004d99; text-align: center;"  >TOUTE REPRODUCTION DE CE CODE EST FORMELLEMENT INTERDITE SOUS PEINE DE POURSUITE </p></marquee>
            </div>
