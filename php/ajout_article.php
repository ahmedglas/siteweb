							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Boutique<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="product-details.html">Details de produit</a></li> 
...
if (isset($_POST['registerart'])) {
  ...
  echo
   $insert = " INSERT INTO article (nom, artdesc, marque,categorie, id_fournisseur, prix, remise, ttc) VALUES('$nom','$article_description','$marque','$categorie','$founisseur','$prix','$remise','$ttc')";
