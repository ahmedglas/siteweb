...
if (isset($_POST['registeruser'])) {
  ...
  echo
   $insert = " INSERT INTO utilisateur (nom, poste, quartier,avatar, sexe, numero, email, matricule, password) VALUES('$nom','$poste','$quartier','$avatar','$sex','$numero','$email','$matricule','$password')";
