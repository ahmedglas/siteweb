   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#!"><i class="fa fa-database" aria-hidden="true"></i>STORAGE SYSTEM  <?php $a = "> Ajouter un membre"; echo " $a ";?></a>
        </div>
...
<div  class="container">
  <p style="text-align: center; color: #004d99 !important;">Enregistrement d'un membre <img src="icons/user1.png" alt="user1" width=""></h1><br></p>
  <hr>
